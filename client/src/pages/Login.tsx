      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold">
            ...
            <span className="text-orange-500">mote</span>
          </h1>
          <p className="text-gray-400 mt-2">Track your LeetCode progress</p>
        </div>
        ...
        <div className="bg-gray-900 rounded-xl p-8 shadow-xl">
          ...
          <button
            ...
            className="w-full py-3 bg-white text-gray-900 rounded-lg font-medium hover:bg-gray-100 transition-colors flex items-center justify-center gap-3"
          >
